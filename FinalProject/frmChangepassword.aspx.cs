...
namespace FinalProject
{
    public partial class frmChangepassword : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //SqlCommand cmd = new SqlCommand("Select * from tbl_Student WHERE Username=@Username AND Password=@password", con);
            ...
            //    SqlCommand cmd1 = new SqlCommand("Update tbl_Student set Password= @Password Where Username = @Username", con1);
            ...
            //    ScriptManager.RegisterStartupScript(this, this.GetType(), "message", "alert('Old Password is Incorrect');location.href = 'frmChangepassword.aspx';", true);
