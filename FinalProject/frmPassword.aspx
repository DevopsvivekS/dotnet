<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPassword.aspx.cs" Inherits="FinalProject.frmPassword" %>
    ...
    <form id="form1" runat="server" style="text-align:center; color: yellow">
        ...
        <div class ="row">
            ...
            <h1 style="color:yellow"><b>CHANGE PASSWORD</b></h1><br />
                ...
                <br />
                <asp:TextBox ID="txtConfirmpassword" runat="server" required="true" Class ="rounded" placeholder="Confirm Password" style="width:60%" TextMode="Password"></asp:TextBox><br />
                ...
                <br />
                <asp:Button ID="Button1" class="btn btn-success" runat="server" Text="Submit" style="width:30%" OnClick="Button1_Click" />&nbsp&nbsp
                <asp:Button ID="Button2" class="btn btn-danger" runat="server" Text="Logout" style="width:30%" OnClientClick="return confirm ('Are you sure?');" OnClick="btnLogout_Click"/>&nbsp&nbsp
                 <a class="btn btn-dark" href="adminDashboard.aspx" style="width:30%">Dashboard</a>&nbsp&nbsp
                <br /><br />
                  </div>
